...
export default function Home() {
  ...
  const handleArchiveToggle = (msg: Msg) => {
  ...
  return (
    <>
            ...
            <div style={{ position: 'relative', marginBottom: 10 }}>
              ...
              <input
                ...
                style={{
                  ...
                  borderRadius: 12, padding: '10px 36px', color: '#f5f5f5', fontSize: 14, outline: 'none',
                }}
              />
              {searchQuery && (
                <button
                  onClick={() => setSearchQuery('')}
                  style={{ position: 'absolute', right: 10, top: '50%', transform: 'translateY(-50%)', background: 'none', border: 'none', color: 'rgba(255,255,255,0.35)', cursor: 'pointer', fontSize: 18, lineHeight: 1, padding: '2px 4px' }}
                >
                  {'\u00d7'}
                </button>
              )}
          ...
          {loading ? (
            ...
            <div style={{ textAlign: 'center', padding: '80px 20px', color: 'rgba(255,255,255,0.25)' }}>
              <div style={{ fontSize: 36, marginBottom: 14 }}>
                {searchQuery ? '\u{1F50D}' : activeTab === 'archived' ? '\u{1F5C4}' : '\u2709'}
              </div>
            ...
            messages.map((msg, i) => (
              <div
                ...
                style={{
                  padding: '15px 20px', borderBottom: '1px solid rgba(255,255,255,0.04)',
                  cursor: 'pointer', animation: `fadeIn 0.25s ease ${Math.min(i * 0.04, 0.3)}s both`,
              ...
              >
                <div style={{ display: 'flex', gap: 12, alignItems: 'flex-start' }}>
                  ...
                  <div style={{
                    ...
                    background: 'linear-gradient(135deg, rgba(124,58,237,0.4), rgba(124,58,237,0.08))',
                    ...
                    {!msg.read && (
                      <div style={{
                        ...
                        background: '#7c3aed', border: '2px solid #080808',
                      }} />
                    )}
                  </div>
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 4 }}>
                      <span style={{ fontWeight: msg.read ? 400 : 600, fontSize: 15, color: msg.read ? 'rgba(255,255,255,0.7)' : '#fff' }}>
                        {msg.sender || 'Inconnu'}
                      </span>
                    ...
                    <div style={{ marginBottom: 5 }}>
                      <span style={{
                        fontSize: 10, padding: '2px 7px', borderRadius: 6, letterSpacing: 0.3,
                        background: 'rgba(124,58,237,0.12)', color: 'rgba(155,92,255,0.9)',
                    ...
                    {msg.summary && (
                      <p style={{
                        fontSize: 13, color: 'rgba(255,255,255,0.5)', marginBottom: 3, lineHeight: 1.4,
                    ...
                    {/* Last message */}
                    <p style={{
                      fontSize: 12, color: 'rgba(255,255,255,0.28)', lineHeight: 1.4,
                      overflow: 'hidden', display: '-webkit-box', WebkitLineClamp: 1, WebkitBoxOrient: 'vertical',
                    }}>
                      {msg.lastMessage}
                    </p>
      ...
      {selected && (
        <div
          style={{ position: 'fixed', inset: 0, zIndex: 50, background: 'rgba(0,0,0,0.65)', backdropFilter: 'blur(8px)', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end' }}
            ...
            <div style={{ padding: '16px 20px 14px', borderBottom: '1px solid rgba(255,255,255,0.06)', flexShrink: 0 }}>
                ...
                <div style={{ minWidth: 0, flex: 1, paddingRight: 12 }}>
                  ...
                  <div style={{ display: 'flex', gap: 6, alignItems: 'center', flexWrap: 'wrap' }}>
                    ...
                    <span style={{ fontSize: 12, color: 'rgba(255,255,255,0.28)' }}>
                      {new Date(selected.date).toLocaleDateString('fr-FR', { day: '2-digit', month: 'short', hour: '2-digit', minute: '2-digit' })}
                    </span>
                  </div>
                </div>
                <div style={{ display: 'flex', gap: 8, flexShrink: 0 }}>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      color: 'rgba(255,255,255,0.45)', cursor: 'pointer', fontSize: 18,
                    }}
                  >
                    {'\u00d7'}
                  </button>
              ...
              {selected.summary && (
                <div style={{
                  ...
                  <div style={{ fontSize: 10, color: 'rgba(155,92,255,0.7)', marginBottom: 4, fontWeight: 600, letterSpacing: 0.5, textTransform: 'uppercase' }}>
                    R\u00e9sum\u00e9 IA
                  </div>
            ...
            <div ref={threadRef} style={{ flex: 1, overflowY: 'auto', padding: '12px 20px' }}>
              {threadLoading ? (
                ...
                groupByDate(thread).map(([date, msgs]) => (
                  <div key={date}>
                    <div style={{ textAlign: 'center', margin: '12px 0', fontSize: 11, color: 'rgba(255,255,255,0.22)', letterSpacing: 0.4 }}>
                      {date}
                    </div>
                      ...
                      {msgs.map((m) => (
                        <div key={m.id} style={{ display: 'flex', justifyContent: m.direction === 'outbound' ? 'flex-end' : 'flex-start' }}>
                          <div style={{
                            ...
                            background: m.direction === 'outbound' ? '#7c3aed' : 'rgba(255,255,255,0.07)',
              ...
              <div style={{ padding: '10px 16px 32px', borderTop: '1px solid rgba(255,255,255,0.05)', flexShrink: 0 }}>
                <div style={{ display: 'flex', gap: 10, alignItems: 'flex-end' }}>
                  <textarea
                    ...
                    placeholder={`R\u00e9pondre via ${selected.source}...`}
                    rows={1}
                    style={{
                      flex: 1, background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.09)',
                      borderRadius: 14, padding: '11px 14px', color: '#f5f5f5', fontSize: 14,
                      outline: 'none', resize: 'none', fontFamily: 'inherit', lineHeight: 1.45,
                  ...
                  <button
                    ...
                    style={{
                      ...
                      background: replyText.trim() && !sending ? '#7c3aed' : 'rgba(124,58,237,0.25)',
                  ...
                  >
                    {sending ? (
                      ...
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                        <path d="M13.5 8L2.5 2.5l2.5 5.5-2.5 5.5 11-5.5z" fill="white" />
                      </svg>
                    )}
                  </button>
                </div>
